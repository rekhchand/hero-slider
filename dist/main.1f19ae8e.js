...
var revealBg = document.querySelector('.reveal-bg'),
...
window.onload = function () {
  var loading = document.querySelector('header .loading');
  loading.style.animation = "loading ".concat(intervalTime, "ms linear infinite");
  ...
  var slideInterval; // number of Dots

  var dots = document.querySelector('header .slider-dots');
  ...
  var spanDots = document.querySelectorAll('header .slider-dots span');

  var nextAnim = function nextAnim() {
    _gsap.gsap.fromTo(".slide.current", {
      x: "100%"
    }, {
      duration: 1,
      x: 0,
    ...
    _gsap.gsap.fromTo(sliderContentBar, {
      width: "100%"
    }, {
      duration: 0.5,
      delay: 0.7,
  ...
  var nextSlide = function nextSlide() {
    // Reset
    var current = document.querySelector('header .slide.current');
    ...
    var dotCurrent = document.querySelector('header .slider-dots span.current');
    dotCurrent.classList.remove('current'); // Logic
  ...
  var resetAutoAnim = function resetAutoAnim() {
    if (auto) {
  ...
  spanDots.forEach(function (dot, i) {
